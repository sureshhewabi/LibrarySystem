package lk.dhamma.library.webapp.controller;

import lk.dhamma.library.webapp.model.Borrowal;
import lk.dhamma.library.webapp.service.BorrowalService;
import lk.dhamma.library.webapp.util.CustomErrorType;
